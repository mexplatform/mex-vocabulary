...
import example.tests.framework.Start;
import example.tests.framework.algo.Algorithm;
import example.tests.framework.core.*;
import example.tests.framework.perf.Measure;
