...
import org.aksw.mex.framework.ExecutionHelperKey;
...
public class MEXService {
    ...
    private final static MyMEX_10 mex = new MyMEX_10();

    /* metafile */
    private static String outputPath = "/Users/dnes/github/mexproject/metafiles/framework/"; //the path for the output file
    private static String outputFileName = "exWeka001.ttl"; //the output filename
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //Class<?> klass = JSATExample001.class;
            ...
            if (klass.isAnnotationPresent(SamplingMethod.class)) {
                Annotation annotationHard = klass.getAnnotation(SamplingMethod.class);
                SamplingMethod aSM = (SamplingMethod) annotationHard;
            ...
            MEXSerializer_10.getInstance().saveToDisk(outputPath + outputFileName,"http://mex.aksw.org/examples/ESWC/001/", mex);
            LOG.info("The MEX file " + outputFileName + " has been successfully created: share it ;-)");
    ...
    private static boolean addExecutions(List<Field> _measures, Object ins, HashMap<String, AlgorithmVO> algorithms) throws Exception{
        ...
        try{
            ...
            if ((_measures.get(0).getAnnotation(Measure.class).algorithmID().equals("")) &&
                ...
                for (int i=1; i<totalExecutions+1; i++){
                    ...
                    mex.Configuration().ExecutionOverall(String.valueOf(i)).setAlgorithm(algtemp);
                    ...
                    for (Field fa : _measures) {
                        ...
                        mex.Configuration().ExecutionOverall(String.valueOf(i)).addPerformance(
                                m.name(), Double.parseDouble(mValue.get(i).toString()));


                        LOG.info(m.name() + " of Execution " + i + " : " + mValue.get(i).toString());
                    }
