...
def set_experiment_info():
    params = {'author': "Igor Costa", 'email': "igorcosta@ime.eb.br", 'title': "Scikit Learn Test", 'tags': ['Scikit Learn', 'Python 2.7', 'MEX', 'Iris']}
    return params

@mex_framework.hardware
def set_hardware_info():
    params = {'cpu': "Intel Core i7", 'memory': "8 GB", 'hd': "SSD", 'cache': '6M',' os': 'OSX El Capitan 10.11.6', 'video': 'Nvidia GForce 630M'}
    return params
...
def algorithm():
    params = {'algorithmID' : '1', 'algorithmName':'K-Nearest Neighbors', 'algorithmURI': 'http://scikit-learn.org/stable/modules/neighbors.html', 'algorithmClass': 'NearestNeighbor'}
    return params

@mex_framework.measure
def measure():
    params = {'idMeasure' : 'ACCURACY', 'algorithmID': '1', 'idPhase': 'TEST'}
    return params
