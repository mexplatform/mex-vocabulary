<div class="panel panel-default">
    ...
    <div class="panel-body"> 
        <div>
            ...
            <br>                
          <input required placeholder="" type="text" class="dataset input" ng-model="ds.idenExp">
            <br/>
            ...
            <br>                
          <input required placeholder="" class="input" type="text" ng-model="ds.titleExp">
            <br/>
            <label>Date<span style="color: red">*</span> </label>  
            <a class="desc2" target="_blank" href='http://xmlns.com/foaf/spec/#term_homepage'>dcterms:date</a>   
            <br>                
          <input required placeholder="" class="input"  type="text" ng-model="ds.dateExp">
            <br/>
            <label>Description<span style="color: red">*</span> </label>  
            <a class="desc2" target="_blank" href='http://usefulinc.com/ns/doap#homepage'>dcterms:description</a>   
            <br>                
          <input required placeholder="" class="input"   type="text" ng-model="ds.descriExp">
            <br/>
            ...
            <br>                
          <textarea required class="input" rows="6" ng-model="ds.dateNormDes"></textarea>
            <br/>
            ...
            <br>                
            <input required placeholder="" type="text" class="dataset input" ng-model="ds.outRemoDes">
            <br/>
             ...
             <br>
              <input required placeholder="" type="text" class="dataset input" ng-model="ds.noiseRemoDes">
              <br>   
            ...
            <br>                
            <input required size="51" type="text" class="dataset input" ng-model="ds.attSelecDes">
             <br>
        </div>
    </div>
</div>