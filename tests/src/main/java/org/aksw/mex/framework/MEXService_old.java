...
public class MEXService_old {

    /* general */
    private final static String javaDocURL = "http://mex.aksw.org/framework/doc";
    private final static Logger LOG = Logger.getLogger(MEXService_old.class);
...
/* EXECUTIONS and MEASURES *//*
            ...
            MEXSerializer.getInstance().saveToDisk(outputPath + outputFileName,"http://mex.aksw.org/examples/ESWC/001/", mex);
