...
public class Example02 {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            String alg01ID = mex.Configuration(conf01ID).addAlgorithm(EnumAlgorithms.NaiveBayes);
            String alg02ID = mex.Configuration(conf02ID).addAlgorithm(EnumAlgorithms.LogisticRegression);
            /* (2.5) the executions */
