    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //ml-experiment-configuration
            {
                ...
                mex.Configuration().addSamplingMethod(EnumSamplingMethods.CROSS_VALIDATION, 0.8, 0.2);
                mex.Configuration().addHardwareConfiguration("ubuntu", EnumProcessors.INTEL_COREI7, EnumRAM.SIZE_16GB, "SSD", EnumCaches.CACHE_3MB);
            ...
            {
                mex.Configuration().addImplementation(EnumImplementations.WEKA, "3.6.6");
