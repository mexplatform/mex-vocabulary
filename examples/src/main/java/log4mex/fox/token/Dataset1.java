        ...
        
         {
           ...
           // mex.Configuration(eid).Execution(ex1).setEndsAtPosition("1376");
            ...
            try{
                ...
                MEXSerializer.getInstance().saveToDisk("/Users/dnes/Github/mexproject/metafiles/log4mex/fox/token/1", "http://mex.aksw.org/examples/", mex, MEXConstant.EnumRDFFormats.TTL);
            }catch (Exception e){
